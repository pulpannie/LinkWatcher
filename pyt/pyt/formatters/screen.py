...
def report(
    ...
    heading = "Screen: {} vulnerabilit{} found{}.\n".format(
...
def vulnerability_to_str(i, vulnerability):
    ...
    for node in vulnerability.reassignment_nodes:
        if node.right_hand_side_variables:
            rhs_list.append(node.right_hand_side_variables)

    lines.append('Total variables that were used in sink variable TODO: ')
    lines.append(rhs_list)
