...
import inspect
import json
from django.utils.link_tee import tags, hashes
...
class QuerySet:
    ...
    def get(self, *args, **kwargs):
        ...
        num = len(clone)
        #print("query1: ", self.query, clone._result_cache[0].password)
        if num == 1:
    ...
    def _insert(self, objs, fields, return_id=False, raw=False, using=None, ignore_conflicts=False):
        ...
        a = query.get_compiler(using=using).execute_sql(return_id)
        #link-TEE _insert
        return a
