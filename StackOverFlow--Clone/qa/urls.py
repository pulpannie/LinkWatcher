...
urlpatterns = [
	...
	path('new_question/', views.new_question.as_view(), name='new_question'),
	path('signup_view/',views.SignUpView.as_view(), name='signup_view'),
      path("delete-user/", views.del_user, name="delete-user"),
	path('answer/', views.questionDetailView.as_view(), name='questionDetailView'),
	path('comment/', views.save_comment.as_view(), name='Comment'),
